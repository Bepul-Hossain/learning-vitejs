        ...
        var t = {
            common: {
                init: function () {
                    ...
                    function r() {
                        o(), e.post(uCookieSetting.ajaxurl, {
                    ...
                    function s() {
                        var e = f("uCookie_gdpr_popup"),
                            t = {};
                        return t.strict = "0", t.thirdparty = "0", t.advanced = "0", e && (e = JSON.parse(e), t.strict = e.strict, t.thirdparty = e.thirdparty, t.advanced = e.advanced, p(t), n("script_inject", e)), void 0 !== uCookieSetting.ifbc ? ("strict" === uCookieSetting.ifbc && e && 1 === parseInt(e.strict) && a(), "thirdparty" === uCookieSetting.ifbc && e && 1 === parseInt(e.thirdparty) && a(), "advanced" === uCookieSetting.ifbc && e && 1 === parseInt(e.advanced) && a()) : "1" !== uCookieSetting.strict_init && a(), t
                    }
                    ...
                    function c(o) {
                        var r = !1;
                        try {
                            void 0 !== uCookieSetting.force_reload && "true" === uCookieSetting.force_reload && (r = !0)
                        } catch (e) { }
                        var i = s(),
                            a = uCookieSetting.enabled_default.third_party,
                            d = uCookieSetting.enabled_default.advanced;
                    ...
                    function _() {
                        e("#uCookie_bar").length > 0 && (e("#uCookie_bar").addClass("uCookie-gdpr-info-bar-hidden"), e("body").removeClass("gdpr-infobar-visible"))
                    }

                    function l() {
                        var o = !0;
                        if ("undefined" != typeof sessionStorage && 1 === parseInt(sessionStorage.getItem("gdpr_infobar_hidden")) && (o = !1), void 0 !== uCookieSetting.display_cookie_banner && o) {
                            if ("true" === uCookieSetting.display_cookie_banner) e("#uCookie_bar").length > 0 && (e("#uCookie_bar").removeClass("uCookie-gdpr-info-bar-hidden"), e("#uCookie_gdpr_save_popup_settings_button:not(.button-visible)").hide(), e("body").addClass("gdpr-infobar-visible"), n("show_infobar", ""));
                            else if (e("#uCookie_bar").length > 0) {
                                e("#uCookie_bar").addClass("uCookie-gdpr-info-bar-hidden"), e("body").removeClass("gdpr-infobar-visible");
                                var r = {
                                    strict: 1,
                                    thirdparty: 1,
                                    advanced: 1
                        ...
                        } else e("#uCookie_bar").length > 0 && o && (e("#uCookie_bar").removeClass("uCookie-gdpr-info-bar-hidden"), e("#uCookie_gdpr_save_popup_settings_button:not(.button-visible)").hide(), e("body").addClass("gdpr-infobar-visible"), n("show_infobar", ""))
                    }
                    ...
                    function u(e, o, r) {
                        ...
                        try {
                            var a = "SameSite=Lax";
                            void 0 !== uCookieSetting.cookie_attributes && (a = uCookieSetting.cookie_attributes), void 0 !== uCookieSetting.gdpr_consent_version && (o = JSON.parse(o), o.version = uCookieSetting.gdpr_consent_version, o = JSON.stringify(o)), document.cookie = encodeURIComponent(e) + "=" + encodeURIComponent(o) + n + "; path=/; " + a, i(o)
                        } catch (e) {
                        ...
                        for (var t = encodeURIComponent(e) + "=", o = document.cookie.split(";"), r = 0; r < o.length; r++) {
                            ...
                            if (0 === n.indexOf(t)) {
                                var i = decodeURIComponent(n.substring(t.length, n.length)),
                                    s = JSON.parse(i);
                                if (void 0 !== s.version) {
                                    if (void 0 !== uCookieSetting.gdpr_consent_version) {
                                        var a = uCookieSetting.gdpr_consent_version;
                                        if (parseFloat(a) > parseFloat(s.version)) return document.cookie = e + "=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;", null
                                    }
                                } else if (void 0 !== uCookieSetting.gdpr_consent_version && parseFloat(uCookieSetting.gdpr_consent_version) > 1) return document.cookie = e + "=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;", null;
                                return i
                            }
                        }
                        return null
                    ...
                    function v(t) {
                        if (S = s(), t) {
                            ...
                            if (n("script_inject", t), C = !0, void 0 !== uCookieSetting.ifbc ? ("strict" === uCookieSetting.ifbc && t && 1 === parseInt(t.strict) && a(), "thirdparty" === uCookieSetting.ifbc && t && 1 === parseInt(t.thirdparty) && a(), "advanced" === uCookieSetting.ifbc && t && 1 === parseInt(t.advanced) && a()) : 1 === parseInt(t.strict) && a(), void 0 !== uCookieSetting.scripts_defined) try {
                                var d = JSON.parse(uCookieSetting.scripts_defined);
                                ...
                                console.error(e)
                            } else void 0 !== k.thirdparty && void 0 !== k.advanced || (1 === t.thirdparty && (k.thirdparty = !0), 1 === t.advanced && (k.advanced = !0), e.post(uCookieSetting.ajaxurl, {
                                action: "uCookie_gdpr_get_scripts",
                                strict: t.strict,
                    ...
                    function m() {
                        var t = !0;
                        e(document).find("#uCookie_modal input[type=checkbox]").each(function () {
                    ...
                    var y = 365,
                        k = [];
                    void 0 !== uCookieSetting.cookie_expiration && (y = uCookieSetting.cookie_expiration),

                        e(document).on("click", '#uCookie_bar .btn-reject, [href*="#gdpr-reject-cookies"]', function (t) {
                            t.preventDefault(), h(), r(), e("#uCookie_bar").length > 0 && (e("#uCookie_bar").addClass("uCookie-gdpr-info-bar-hidden"), e("body").removeClass("gdpr-infobar-visible"), e("#uCookie_gdpr_save_popup_settings_button").show()),
                                setTimeout(function () {
                                    document.cookie = "";
                                    //u("uCookie_gdpr_popup", JSON.stringify({
                                    //    strict: "1",
                    ...
                    if (e.fn.uCookie_gdpr_save_cookie = function (t) {
                        ...
                        if (!o) {
                            ...
                            if (o = f("uCookie_gdpr_popup"))
                                if (o = JSON.parse(o), n("script_inject", o), C = !0, void 0 !== uCookieSetting.ifbc ? ("strict" === uCookieSetting.ifbc && o && 1 === parseInt(o.strict) && a(), "thirdparty" === uCookieSetting.ifbc && o && 1 === parseInt(o.thirdparty) && a(), "advanced" === uCookieSetting.ifbc && o && 1 === parseInt(o.advanced) && a()) : 1 === parseInt(o.strict) && a(), void 0 !== uCookieSetting.scripts_defined) try {
                                    var _ = JSON.parse(uCookieSetting.scripts_defined);
                                    ...
                                    console.error(e)
                                } else void 0 !== k.thirdparty && void 0 !== k.advanced || (1 === o.thirdparty && (k.thirdparty = !0), 1 === o.advanced && (k.advanced = !0), e.post(uCookieSetting.ajaxurl, {
                                    action: "uCookie_gdpr_get_scripts",
                                    strict: o.strict,
                    ...
                    }, "undefined" == typeof lity && "true" === uCookieSetting.load_lity) {
                        var N = uCookieSetting.plugin_dir + "/lity.js",
                            I = uCookieSetting.plugin_dir + "/lity.css";
                    ...
                    if (window.location.hash) {
                        ...
                        "uCookie_modal" === A && (j = !0, n("opened_modal_from_link", ""), setTimeout(function () {
                            e("#uCookie_modal").length > 0 && (O = lity("#uCookie_modal"), e("#uCookie_gdpr_strict_cookies").click().click(), e(".lity").addClass("uCookie_modal_open"), e(document).uCookie_lity_open())
                        }, 500))
                    }
                    if (window.location.hash) {
                        var A = window.location.hash.substring(1);
                    ...
                    e(document).on("click", "#uCookie_bar .uCookie-gdpr-infobar-close-btn", function (t) {
                        ...
                        function () {
                            ...
                            var r = uCookieSetting.enabled_default.third_party,
                                n = uCookieSetting.enabled_default.advanced;
                            if (void 0 !== uCookieSetting.enable_on_scroll && "true" === uCookieSetting.enable_on_scroll && 1 !== parseInt(r) && 1 !== parseInt(n) && (r = 1, n = 1), document.cookie.indexOf("uCookie_gdpr_popup") >= 0 || 1 == r || 1 == n) {
                                ...
                                if (i) {
                                    ...
                                    var d = !1;
                                    if ("undefined" != typeof sessionStorage && (d = sessionStorage.getItem("gdpr_session")), void 0 !== uCookieSetting.enable_on_scroll && "true" === uCookieSetting.enable_on_scroll) {
                                        if (d) try {
                                            p(JSON.parse(d)), C = !0, t("dbg - inject - 1"), v(d), u("uCookie_gdpr_popup", d, y), _()
                                        } catch (e) { } else if ((!C && 1 == uCookieSetting.enabled_default.third_party || !C && 1 == uCookieSetting.enabled_default.advanced) && (i = {
                                            strict: 1,
                                            thirdparty: r,
                                            advanced: n
                                        }, p(i), i = JSON.stringify(i), b = !0, l(), t("dbg - default scroll inject")), void 0 !== uCookieSetting.gdpr_aos_hide && ("1" === uCookieSetting.gdpr_aos_hide || "true" === uCookieSetting.gdpr_aos_hide || "object" == typeof uCookieSetting.gdpr_aos_hide && uCookieSetting.gdpr_aos_hide.includes("1")) && (t("dbg - enable on scroll - enter"), e(window).scroll(function () {
                                        ...
                                        })), void 0 !== uCookieSetting.gdpr_aos_hide && ("2" === uCookieSetting.gdpr_aos_hide || "object" == typeof uCookieSetting.gdpr_aos_hide && uCookieSetting.gdpr_aos_hide.includes("2"))) {
                                            var m = 30;
                                            if (void 0 !== uCookieSetting.gdpr_aos_hide_seconds) var m = parseInt(uCookieSetting.gdpr_aos_hide_seconds);
                        ...
                        }(), e(document).on("click", '[data-href*="#uCookie_modal"],[href*="#uCookie_modal"]', function (t) {
                            t.preventDefault(), e("#uCookie_modal").length > 0 && (j = !0, O = lity("#uCookie_modal"), e("#uCookie_gdpr_strict_cookies").click().click(), e(".lity").addClass("uCookie_modal_open"), e(document).uCookie_lity_open(), n("opened_modal_from_link", ""))
                        }), e(document).on("click", '[data-href*="#gdpr_cookie_modal"],[href*="#gdpr_cookie_modal"]', function (t) {
                            t.preventDefault(), e("#uCookie_modal").length > 0 && (j = !0, O = lity("#uCookie_modal"), e("#uCookie_gdpr_strict_cookies").click().click(), e(".lity").addClass("uCookie_modal_open"), e(document).uCookie_lity_open(), n("opened_modal_from_link", ""))
                        }), e(document).on("click", "#uCookie_bar .uCookie-gdpr-close-modal-button a, #uCookie_bar .uCookie-gdpr-close-modal-button button", function (e) {
                            e.preventDefault()
                        }), e(document).on("click", ".uCookie-modal-close", function (t) {
                            ...
                            if (j) {
                                ...
                                var o = f("uCookie_gdpr_popup");
                                "none" === uCookieSetting.show_icons && e("body").addClass("gdpr-no-icons"), e(".uCookie-gdpr-status-bar input[type=checkbox]").each(function () {
                            ...
                            e("#uCookie_modal .uCookie-gdpr-modal-content").is(".uCookie_gdpr_modal_theme_v2") ? (e("#uCookie_gdpr_strict_cookies").click(), e(this).click()) : e(this).closest(".uCookie-gdpr-tab-main-content").find(".uCookie-gdpr-strict-secondary-warning-message").slideDown()
                            ...
                            t.preventDefault(), e("#uCookie_modal").find("input[type=checkbox]").each(function () {
                                var t = e(this);
                                t.is(":checked") || t.click()
                            }), d("enable_all enable-all-button"), e(".lity .lity-close").click(), _(), g(), e(document).uCookie_lity_close()
                        }), e(document).on("click", ".btn-allow-all", function (e) {
            ...
            o = {
                ...
                loadEvents: function () {
                    var t = !1;
                    void 0 !== uCookieSetting.geo_location && "true" === uCookieSetting.geo_location ? jQuery.post(uCookieSetting.ajaxurl, {
                        action: "uCookie_gdpr_localize_scripts"
                    }, function (e) {
                        var r = JSON.parse(e);
                        void 0 !== r.display_cookie_banner && (uCookieSetting.display_cookie_banner = r.display_cookie_banner), void 0 !== r.enabled_default && (uCookieSetting.enabled_default = r.enabled_default), t || (t = !0, o.fire("common"))
    ...
    if (myIndex == 0) {
        ...
        jQuery.get("/umbraco/api/CookieData/get/1", function (res) {
            if (cookies != null) {
                ...
                $("#uCookie_gdpr_performance_cookies").prop('checked', res.ThrdPartyStatus);
            }
        });
    }
}
